...
CREATE INDEX idx_giang_vien_user_id ON GIANG_VIEN(user_id);
CREATE INDEX idx_giang_vien_ma_cd_ma_hv ON GIANG_VIEN(ma_cd, ma_hv);
...
CREATE INDEX idx_nhat_ky_ma_lich ON NHAT_KY_GIANG_DAY(ma_lich);
...
('ROLE_ADMIN', 'Quản trị viên'), ('ROLE_GIAO_VU', 'Giáo vụ'), ('ROLE_GIANG_VIEN', 'Giảng viên'), ('ROLE_SINH_VIEN', 'Sinh viên');

-- Admin & Giáo vụ users (password: 123456)
INSERT INTO USERS (username, password_hash) VALUES
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'),
('giao_vu_01', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy');

INSERT INTO USER_ROLES (user_id, role_id) VALUES
((SELECT id FROM USERS WHERE username = 'admin'), (SELECT id FROM ROLES WHERE role_name = 'ROLE_ADMIN')),
((SELECT id FROM USERS WHERE username = 'giao_vu_01'), (SELECT id FROM ROLES WHERE role_name = 'ROLE_GIAO_VU'));

-- 4.3 Sinh 1000 Giảng Viên & Mapping User (với hash chuẩn BCrypt của mật khẩu 123456)
WITH new_gv_users AS (
    INSERT INTO USERS (username, password_hash)
    SELECT 'GV_' || LPAD(i::text, 4, '0'), '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'
...
WITH new_sv_users AS (
    INSERT INTO USERS (username, password_hash)
    SELECT 'SV_' || LPAD(i::text, 4, '0'), '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'
