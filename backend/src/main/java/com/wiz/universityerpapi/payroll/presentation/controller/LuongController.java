package com.wiz.universityerpapi.payroll.presentation.controller;
...
import com.wiz.universityerpapi.payroll.application.service.ILuongService;
import com.wiz.universityerpapi.payroll.application.service.SalaryExportService;
...
import com.wiz.universityerpapi.core.security.AuthorizationConstants;
...
public class LuongController {
    ...
    public ResponseEntity<Resource> exportExcel(@RequestParam("thang") Integer thang,
        ...
        try {
            ...
            throw new com.wiz.universityerpapi.core.exception.BusinessRuleViolationException("Không thể tạo file Excel: " + e.getMessage());
        }
    }
}
